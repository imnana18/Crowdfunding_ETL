...
Refer to `ETL_Mini_Project.ipynb` for detailed code with notes for process parts 1-3. Refer to `Crowdfunding_Database` folder for creating the process part 4.
