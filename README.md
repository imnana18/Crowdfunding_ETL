...
Refer to `ETL_Mini_Project.ipynb` and `Resources` folder for detailed code with notes for process parts 1-3. Refer to `Crowdfunding_Database` folder in Resources folder for process part 4.
